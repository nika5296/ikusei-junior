...
/**
 * 現在開いているスプレッドシートを Web アプリ・バッチのデータ参照先に固定する。
 * ・スプレッドシートを複製したあと、同じデプロイURLで複製ブックのマスタを読ませたいときに実行。
 * ・このプロジェクトが clasp で別ブックにバインドされていない場合でも効く。
 */
...
/** 参照先上書きを解除し、コンテナにバインドされたブックだけを参照する（既定動作） */
